        ...
        <motion.div initial={{opacity : 0}} animate={{opacity : 1}}>
            <section className="flex flex-col space-y-4">
                ...
                <form className="flex flex-col">    
                    ...
                    <input className="border border-zinc-900 h-10 mb-3 px-2 rounded-md" id="email" type="text" />
                    <label className="py-2 text-sm" htmlFor="password">Password</label>
                    <input className="border border-zinc-900 h-10 mb-3 px-2 rounded-md" id="password" type="password" />

                    <Link className="mb-10 self-end text-sm underline" path="/">Forgot Password?</Link>
                    <button className="h-12 bg-zinc-900 text-white text-sm rounded-md">Sign In</button>
                </form>
            </section>
        </motion.div>
    );
