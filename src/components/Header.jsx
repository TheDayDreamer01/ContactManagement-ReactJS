...
const Header = () => {
    ...
    return (
        <header className={`p-4 md:px-8 border-b border-neutral-900 dark:border-neutral-500 grid grid-cols-2 md:grid-cols-3 items-center ${isDark ? "dark:bg-neutral-800 dark:text-white" : ""}`}>
            <div className="flex items-center">
                <button className="block md:hidden p-2 mr-2 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700"
            ...
            <div className="hidden md:block relative">
                <input
                    className="border pl-12 pr-2 border-neutral-900 dark:border-neutral-500 h-10 px-2 w-full justify-self-center bg-neutral-100 dark:bg-neutral-600 dark:text-white rounded-md"
